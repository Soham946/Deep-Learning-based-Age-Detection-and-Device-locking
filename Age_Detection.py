...
class FaceCV(object):
    ...
    def __init__(self, depth=16, width=8, face_size=64):
        ...
        fpath = get_file('F:/Reducing_Screen_Time_Project/weights.18-4.06.hdf5',
    ...
    def detect_face(self):
        ...
        while True:
            ...
            if len(faces) > 0:
                ...
                # draw results
                for i, face in enumerate(faces):
                    label = "{} years".format(int(predicted_ages[i]))
                    print(int(predicted_ages[i]))
                    '''
                    Important sleep function for < 12
                    '''

                    if int(predicted_ages[i]) < 12:
                        system_sleep()
